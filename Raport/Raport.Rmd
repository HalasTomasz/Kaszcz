...
\section{Przedziały ufności dla $\beta_1$ i $\beta0$} \label{section:ufnosc}

|      W celu kostrukcji przedziałów ufności posłużymy się estymatorami $\hat{\beta_0}$ $\hat{\beta_1}$ i ich własnościami:
